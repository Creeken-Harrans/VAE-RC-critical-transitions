...
CONFIG_DIR = Path("/tmp/lorenz_eval_layer_configs_round28_kb")
OUT_ROOT = REPO / "outputs_abfull" / "eval_layer_kb_round28"


VARIANTS = [
    {"name": "kb20_n30", "kb": 2.0},
    {"name": "kb25_n30", "kb": 2.5},
    {"name": "kb35_n30", "kb": 3.5},
    {"name": "kb40_n30", "kb": 4.0},
]
...
def main() -> None:
    ...
    for variant in VARIANTS:
        ...
        row.update(counts)
        rows.append(row)
        (OUT_ROOT / "round28_kb_summary.json").write_text(
