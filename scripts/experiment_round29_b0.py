...
CONFIG_DIR = Path("/tmp/lorenz_eval_layer_configs_round29_b0")
OUT_ROOT = REPO / "outputs_abfull" / "eval_layer_b0_round29"


VARIANTS = [
    {"name": "b025_n30", "b0": 2.5},
    {"name": "b030_n30", "b0": 3.0},
    {"name": "b040_n30", "b0": 4.0},
    {"name": "b045_n30", "b0": 4.5},
]
...
def main() -> None:
    ...
    for variant in VARIANTS:
        ...
        row.update(counts)
        rows.append(row)
        (OUT_ROOT / "round29_b0_summary.json").write_text(
