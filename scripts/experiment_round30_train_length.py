...
CONFIG_DIR = Path("/tmp/lorenz_eval_layer_configs_round30_train_length")
OUT_ROOT = REPO / "outputs_abfull" / "eval_layer_train_length_round30"


VARIANTS = [
    {"name": "train400_n30", "train_length": 400},
    {"name": "train600_n30", "train_length": 600},
    {"name": "train700_n30", "train_length": 700},
    {"name": "train800_n30", "train_length": 800},
]
...
def main() -> None:
    ...
    for variant in VARIANTS:
        ...
        cfg["reservoir"]["train_length"] = variant["train_length"]
        ...
        row = {
            "name": variant["name"],
            "train_length": variant["train_length"],
            "control_train_length": 500,
            "lambda": 1.34,
            "kin": 0.04,
            "kb": 3.0,
            "b0": 3.5,
        ...
        row.update(counts)
        rows.append(row)
        (OUT_ROOT / "round30_train_length_summary.json").write_text(
