...
CONFIG_DIR = Path("/tmp/lorenz_eval_layer_configs_round15_n100")
OUT_ROOT = REPO / "outputs_abfull" / "eval_layer_n100_round15"
...
def main() -> None:
    ...
    cfg["detector"]["tail_std_ratio_threshold"] = 0.300
    cfg["detector"]["tail_amplitude_ratio_threshold"] = 0.300

    name = "ridge1e-4_ratio0300_predict400_n100"
    ...
    with (OUT_ROOT / "round15_n100_summary.json").open("w", encoding="utf-8") as f:
