...
CONFIG_DIR = Path("/tmp/lorenz_eval_layer_configs_round19_n1000_ridge7e5")
OUT_ROOT = REPO / "outputs_abfull" / "eval_layer_n1000_ridge7e5_round19"
...
def main() -> None:
    ...
    cfg["evaluation"]["num_realizations"] = 1000
    ...
    name = "ridge7e-5_ratio0375_predict400_n1000"
    ...
    with (OUT_ROOT / "round19_n1000_ridge7e5_summary.json").open("w", encoding="utf-8") as f:
