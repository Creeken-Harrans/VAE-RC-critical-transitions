...
CONFIG_DIR = Path("/tmp/lorenz_eval_layer_configs_round26_lambda_local")
OUT_ROOT = REPO / "outputs_abfull" / "eval_layer_lambda_round26_local"


VARIANTS = [
    {"name": "lambda140_n30", "lambda": 1.40},
    {"name": "lambda142_n30", "lambda": 1.42},
    {"name": "lambda147_n30", "lambda": 1.47},
    {"name": "lambda150_n30", "lambda": 1.50},
]
...
def main() -> None:
    ...
    for variant in VARIANTS:
        ...
        row.update(counts)
        rows.append(row)
        (OUT_ROOT / "round26_lambda_local_summary.json").write_text(
