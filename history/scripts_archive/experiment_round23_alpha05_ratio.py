...
CONFIG_DIR = Path("/tmp/lorenz_eval_layer_configs_round23_alpha05_ratio")
OUT_ROOT = REPO / "outputs_abfull" / "eval_layer_alpha05_ratio_round23"


VARIANTS = [
    {"name": "alpha0p5_ratio0350_n30", "ratio": 0.350},
    {"name": "alpha0p5_ratio0325_n30", "ratio": 0.325},
]
...
def main() -> None:
    ...
    for variant in VARIANTS:
        ...
        with (OUT_ROOT / "round23_alpha05_ratio_summary.json").open("w", encoding="utf-8") as f:
